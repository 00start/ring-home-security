...
<div class="flex gap-8">
	...
	<div class="flex-1 space-y-8">
		...
		<!-- Account Settings -->
		<Card title="Account" data-testid="settings-account-section" id="account">
			{#snippet children()}
				<div class="space-y-4">
					<div>
		...
		<!-- Notification Settings -->
		<Card title="Notifications" data-testid="settings-notifications-section" id="notifications">
			{#snippet children()}
				<div class="space-y-6">
					<!-- Browser Permission -->
		...
		<!-- System Information -->
		<Card title="System Information" data-testid="settings-system-section" id="system">
			{#snippet children()}
				<div class="space-y-4">
		...
		<!-- User Management -->
		<Card title="User Management" data-testid="settings-users-section" id="users">
			{#snippet children()}
				<div class="space-y-6">
					<!-- Existing Users -->
					<div>
		...
		<!-- Danger Zone -->
		<Card title="Danger Zone" data-testid="settings-danger-section" id="danger">
			{#snippet children()}
				<div class="space-y-4">
					<p class="text-sm text-zinc-500 dark:text-zinc-400">
